...
export const register = async (req, res) => {
  ...
  try {
    ...
    // Configurar la cookie con SameSite=None y Secure=true (si está en HTTPS)
    res.cookie("token", token, {
      sameSite: 'None',
      secure: true, // Cambiar a false si no estás en HTTPS
      httpOnly: true, // Recomendado para proteger la cookie
    });
